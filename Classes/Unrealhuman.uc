// ============================================================
// oldskool.UnrealHuman: This guy is basically tournament player, but nessecary to stop the strafe animations from being called :)
// Psychic_313: DEPRECATED. DON'T USE ME.
// ============================================================

class UnrealHuman expands skinsetclass
  abstract;
...
//the only other change :) (without it dodging screwes up) (ripped from //playerpawn.uc)
...
//yeah..dumb idea... but had to put something :)
function PlayChatting()
{
  if ( mesh != None )
    LoopAnim('Look', 0.7, 0.25);
}
