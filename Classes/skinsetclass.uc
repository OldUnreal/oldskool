// ============================================================
// oldskool.skinsetclass: this baby gets the skin format....
// Psychic_313: DEPRECATED. DON'T USE ME.
// ============================================================

class skinsetclass expands TournamentPlayer
abstract;
...
local Texture NewSkin, Talktestskin;
  ...
  If (Left(Right(default.teamskin, 5),4) != Left(skinitem, 4))   //could use mid but \me don't get it 100%....
